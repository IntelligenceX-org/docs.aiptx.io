...
<Accordion title="What makes validation different?">
...
<CardGroup cols={2}>
  ...
  <Card title="HTTP Proxy" icon="network-wired">
    Intercepts and modifies traffic for authentication bypass and session testing
  </Card>
  <Card title="Dynamic Analysis" icon="code">
...
<Card title="Run Your First Scan" icon="rocket" href="/docs/quickstart">
