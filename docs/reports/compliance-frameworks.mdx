---
title: "Security Compliance Frameworks - SOC 2, ISO 27001, PCI-DSS, HIPAA, GDPR"
sidebarTitle: "Compliance Frameworks"
description: "Map VAPT security findings to compliance requirements. Generate audit-ready reports for SOC 2, ISO 27001, PCI-DSS, HIPAA, GDPR, and NIST frameworks. Automated cyber compliance reporting for security assessments."
icon: "file-certificate"
og:title: "Security Compliance Reporting - SOC 2, ISO 27001, PCI-DSS, HIPAA, GDPR"
og:description: "Generate compliance-ready security reports mapped to SOC 2, ISO 27001, PCI-DSS, HIPAA, GDPR, and NIST frameworks. Automated VAPT compliance."
---

{/* SEO: Primary Keywords - security compliance, SOC 2, ISO 27001, PCI-DSS, HIPAA, GDPR, NIST */}
{/* SEO: Secondary Keywords - compliance reporting, security audit, cyber compliance, VAPT compliance */}

# Compliance Frameworks

<Note>
**AIPTx is SOC 2 Type II & ISO 27001 Certified** — Our platform is independently audited and certified, so you can trust our compliance reports for your own audits.
</Note>

AIPTx maps security findings to major compliance frameworks, helping you demonstrate security posture for audits and certifications. Our reports are accepted by major audit firms worldwide.
...
AIPTx itself maintains the following certifications:
